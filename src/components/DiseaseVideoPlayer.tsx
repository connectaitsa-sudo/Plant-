...
import { X, Play, AlertCircle, CheckCircle, XCircle } from 'lucide-react'
            ...
            >
              <div className="aspect-video bg-black relative">
                <iframe
                  width="100%"
                  height="100%"
                  src={`${diseaseVideo.videoUrl}?autoplay=1`}
              ...
              <div className="p-6 bg-gradient-to-b from-black/50 to-black/80">
                ...
                <p className="text-gray-400">Duration: {diseaseVideo.duration}</p>
              </div>
            </motion.div>
